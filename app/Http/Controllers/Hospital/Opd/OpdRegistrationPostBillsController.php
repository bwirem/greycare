...
class OpdRegistrationPostBillsController extends Controller
{
    use HandlesOrdering;
    ...
    {
        return inertia('Hospital/Opd/Registrations/Partial/Create', [
    ...
    public function confirmSave(Request $request)
    {
        ...
        return inertia('Hospital/Opd/Registrations/Partial/SaveOrderConfirmation', [
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('outpatient0.index')->with('success', 'Order created successfully.');
    }
    ...
    public function edit(BILOrder $order)
    {
        ...
        return inertia('Hospital/Opd/Registrations/Partial/Edit', [
            'order' => $order,
            'fromstore' => SIV_Store::all(),
            'priceCategories' => $this->fetchPriceCategories(),
            'facilityOptions' => FacilityOption::first(),
    ...
    public function confirmUpdate(Request $request, BILOrder $order)
    {
        ...
        return inertia('Hospital/Opd/Registrations/Partial/ConfirmOrderUpdate', [
            'orderData' => $orderData,
    ...
    public function confirmPayment(Request $request)
    {
        ...
        return inertia('Hospital/Opd/Registrations/Partial/ProcessPayment', [
            'orderData' => $validatedData,
    ...
    {      
        ...
        return inertia('Hospital/Opd/Registrations/Partial/ProcessExistingOrderPayment', [
            'orderData' => $orderData,
    ...
    public function processPayment(Request $request, BILOrder $order = null)
    {
        ...
        try {
            ...
            $invoiceUrl = route('outpatient0.billing.invoice_preview');// Default URL
    ...
    public function invoicePreview()
    {
        ...
        if (!$saleId) {
            return redirect()->route('outpatient0.index')->with('error', 'No sale to display.');
        }
