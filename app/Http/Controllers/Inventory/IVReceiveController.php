...
use App\Models\Inventory\SIV_Product; // Assuming you have this Product model
use App\Models\Inventory\SIV_Store;    // Assuming you have a Store Model
use App\Models\Inventory\SPR_Supplier; // Assuming you have a Supplier model
...
class IVReceiveController extends Controller
{
     ...
     */
     ...
     public function index(Request $request)
     {
        ...
        if ($request->filled('stage')) {
         ...
         return inertia('Inventory/IvReceive/Index', [
             'receives' => $receives,
    ...
    {
        return inertia('Inventory/IvReceive/Create', [
    ...
    public function edit(IVReceive $receive)
    {
        ...
        return inertia('Inventory/IvReceive/Edit', [
            'receive' => $receive,
