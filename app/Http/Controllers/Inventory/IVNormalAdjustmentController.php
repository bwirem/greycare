...
class IVNormalAdjustmentController extends Controller
{
    ...
    use ManagesItems;
    // Use our trait for generating unique numbers
    ...
    public function index(Request $request)
    {
        ...
        return inertia('Inventory/IvReconciliation/NormalAdjustment/Index', [
    ...
    {
        return inertia('Inventory/IvReconciliation/NormalAdjustment/Create', [
    ...
    public function edit(IVNormalAdjustment $normaladjustment)
    {
        ...
        return inertia('Inventory/IvReconciliation/NormalAdjustment/Edit', [
