...
class IVPhysicalInventoryController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return inertia('Inventory/IvReconciliation/PhysicalInventory/Index', [
    ...
    {
        return inertia('Inventory/IvReconciliation/PhysicalInventory/Create', [
    ...
    public function edit(IVPhysicalInventory $physicalinventory)
    {
        ...
        return inertia('Inventory/IvReconciliation/PhysicalInventory/Edit', [
