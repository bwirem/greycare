...
use App\Models\Facility\FacilityOption; // +++ IMPORTED
...
class IVRequistionController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return inertia('Inventory/IvRequisition/Index', [
    ...
    {
        return inertia('Inventory/IvRequisition/Create', [
            'fromstore' => SIV_Store::all(), 
    ...
    public function edit(IVRequistion $requistion)
    {
        ...
        return inertia('Inventory/IvRequisition/Edit', [
