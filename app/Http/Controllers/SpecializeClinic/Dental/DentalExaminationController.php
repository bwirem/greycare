...
namespace App\Http\Controllers\SpecializeClinic\Dental;
...
class DentalExaminationController extends Controller
{
    public function index(Request $request)
    {
        ...
        return Inertia::render('SpecializeClinic/Dental/Examination/Index', [
    ...
    {
        return Inertia::render('SpecializeClinic/Dental/Examination/Create', [
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('dental.examination.index')->with('success', 'Dental examination    booked.');
    }
