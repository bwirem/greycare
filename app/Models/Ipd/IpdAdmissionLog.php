...
class IpdAdmissionLog extends Model
{
    protected $table = 'ipd_admission_logs';
    protected $guarded = [];
    ...
    // Relationships to Child Logs
    public function transfers()
    {
        return $this->hasMany(IpdTransferLog::class, 'ipd_admission_log_id');
    }

    public function discharge()
    {
        return $this->hasOne(IpdDischargeLog::class, 'ipd_admission_log_id');
    }
}