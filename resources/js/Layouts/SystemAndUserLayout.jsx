...
import {
    ...
    faCreditCard, faReceipt, faHandHoldingDollar,faFlask
...
const financeModuleKeys = [   
    ...
    'usermanagement'// Parent for User Management (if applicable)
];
                        ...
                        <div className="flex items-center px-4">
                            ...
                            {sidebarVisible && (
                                <h1 className="text-lg font-bold tracking-wide leading-tight">
                                    ...
                                    <span className="text-xs font-normal text-blue-400 block">System & User Admin</span>
                                </h1>
                            )}
                        </div>
                    </Link>
                ...
                <div className="flex-1 overflow-y-auto custom-scrollbar py-4 px-3">
                    <nav>
                        <ul className="space-y-1">
                            ...
                            <SidebarNavLink href={route('dashboard.admin')} icon={faChartBar}>
                                Dashboard
                            </SidebarNavLink>
