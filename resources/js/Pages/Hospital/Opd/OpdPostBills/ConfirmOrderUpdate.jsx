...
export default function ConfirmOrderUpdate({ auth, orderData, originalOrder }) {
    ...
    const submitUpdate = (e) => {
        ...
        put(route('outpatient4.update', { order: orderData.id }), {
            onSuccess: () => {
                    ...
                    <div className="overflow-hidden bg-white dark:bg-gray-800 p-6 shadow-sm sm:rounded-lg">
                        <form onSubmit={submitUpdate} className="space-y-6">                           
                            ...
                            <div className="flex justify-end space-x-3 pt-4 border-t border-gray-200 dark:border-gray-700">
                                <Link href={route('outpatient4.edit', { order: orderData.id })} className="px-4 py-2 bg-gray-200 dark:bg-gray-600 text-gray-800 dark:text-gray-200 rounded-md hover:bg-gray-300 dark:hover:bg-gray-500">Back to Edit</Link>
