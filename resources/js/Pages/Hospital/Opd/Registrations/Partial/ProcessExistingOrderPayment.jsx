...
export default function ProcessExistingOrderPayment({ auth, orderData, originalOrder, paymentMethods }) {
    ...
    const proceedWithSubmission = () => {
        ...
        axios.post(route('outpatient0.billing.pay', { order: orderData.id }), data)
            .then((response) => {
                    ...
                    <div className="overflow-hidden bg-white dark:bg-gray-800 p-6 shadow-sm sm:rounded-lg">
                        <form onSubmit={submitPayment} className="space-y-6">      
                            ...
                            <div className="flex justify-end space-x-3 pt-4 border-t border-gray-200 dark:border-gray-700">
                                <Link href={route('outpatient0.billing.edit', { order: orderData.id })} className="px-4 py-2 bg-gray-200 dark:bg-gray-600 rounded">Back to Edit</Link>
                                <button 
                                    type="submit" 
