...
export default function Index({ auth, orders, filters, success }) {
    ...
    useEffect(() => {
        ...
        searchTimeoutRef.current = setTimeout(() => {
            router.get(route("outpatient0.billing.index"), data, {
                preserveState: true,
                preserveScroll: true, 
                replace: true,        
            });
    ...
    const handleModalConfirm = useCallback(() => {
        ...
        router.delete(route("outpatient0.billing.destroy", modalState.orderToDeleteId), {
            onSuccess: () => {
                    ...
                    <div className="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                        <div className="p-6 text-gray-900">
                            ...
                            <div className="mb-6 flex flex-col gap-4">
                                ...
                                <div className="flex flex-col justify-between gap-4 md:flex-row md:items-center">
                                    <Link
                                        href={route("outpatient0.billing.create")}
                                                    ...
                                                    <tr key={order.id} className="hover:bg-gray-50">
                                                        ...
                                                        <td className="whitespace-nowrap px-4 py-4 text-sm text-center">
                                                            <div className="flex items-center justify-center space-x-2">
                                                                <Link
                                                                    href={route("outpatient0.billing.edit", order.id)}
