...
export default function IpdOrdersTab({ data, setData, options, ordered_labs, ordered_rads, onViewResult }) {
    
    // Local State for Blood Request
    ...
    const handleAddBlood = () => {
        ...
        setBloodReq({ id: null, label: '', units: 1 }); // Reset
    };
