...
export default function ProcessPayment({ auth, orderData, facilityoption, paymentMethods }) {
    ...
    const proceedWithSubmission = () => {
        ...
        axios.post(route('pharmacy0.billing.pay'), data)
            .then((response) => {
                ...
                reset();
                setTimeout(() => {
                    router.visit(route('pharmacy0.index'));
                }, 1500);
            })
            .catch((error) => {
                    ...
                    <div className="overflow-hidden bg-white dark:bg-gray-800 p-6 shadow-sm sm:rounded-lg">
                        <form onSubmit={submitPayment} className="space-y-6">                            
                            ...
                            <div className="flex justify-end space-x-3 pt-4 border-t border-gray-200 dark:border-gray-700">
                                <Link href={route('pharmacy0.billing.create')} className="px-4 py-2 bg-gray-200 dark:bg-gray-600 text-gray-800 dark:text-gray-200 rounded-md hover:bg-gray-300 dark:hover:bg-gray-500">Back</Link>
                                <button 
                                    type="submit" 
