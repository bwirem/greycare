...
export default function Create({ fromstore, priceCategories, auth, facilityOptions }) {
    ...
    const handleProceed = (destination) => {
        ...
        if (destination === 'save') router.post(route('pharmacy0.billing.confirmSave'), payload);
        else if (destination === 'pay') router.post(route('pharmacy0.billing.confirmPayment'), payload);
    };
