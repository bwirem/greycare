                                ...
                                {filteredBills.map((bill) => (
                                    <tr key={bill.id} className="hover:bg-gray-50">
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap text-center text-sm space-x-2">
                                            <a href={route('billing1.edit', bill.id)} target="_blank" rel="noreferrer" className="text-indigo-600 hover:text-indigo-900 bg-indigo-50 px-3 py-1 rounded border border-indigo-200">
