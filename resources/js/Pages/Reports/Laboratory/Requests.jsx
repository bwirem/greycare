...
export default function LabRequestsReport({ auth, reportData, panels, filters }) {
    ...
    const handleSearch = (e) => {
        e.preventDefault();
        get(route('reports.lab.requests'), { preserveState: true });
    };

    return (
        <AuthenticatedLayout user={auth.user} header={<h2 className="text-xl font-semibold">Laboratory Requests Log</h2>}>
            ...
            <div className="py-12 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow mb-6 print:hidden">
                    <form onSubmit={handleSearch} className="grid grid-cols-1 md:grid-cols-5 gap-4 items-end">
                        ...
                        <select value={data.panel_id} onChange={e => setData('panel_id', e.target.value)} className="rounded-md border-gray-300 dark:bg-gray-700 dark:border-gray-600">
                ...
                <div className="bg-white dark:bg-gray-800 shadow rounded-lg p-8 print:shadow-none print:p-0">
                    <div className="text-center mb-6">
                        <h1 className="text-2xl font-bold uppercase text-gray-800 dark:text-white">Laboratory Request Log</h1>
