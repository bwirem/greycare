...
import { faLifeRing, faShieldAlt, faArrowRight, faStethoscope } from '@fortawesome/free-solid-svg-icons';
        ...
        <>
            ...
            <div className="relative min-h-screen flex flex-col items-center justify-center text-white antialiased">
                <div
                    ...
                    // Suggestion: Change this to a hospital/medical related background image
                    style={{ backgroundImage: "url('/img/hospital-bg.jpg')" }} 
                ></div>
                ...
                <div className="relative z-20 w-full max-w-4xl px-6 py-10 lg:max-w-7xl lg:py-16">
                    <header className="flex flex-col sm:flex-row items-center justify-between gap-6 sm:gap-4">
                        <div className="flex-shrink-0">
                            <h1 className={`text-5xl md:text-6xl font-bold ${primaryTextClass} drop-shadow-lg`}>GreyCare</h1>
                        </div>
                    ...
                    <main className="mt-12 md:mt-16">
                        <div className="text-center mb-10 md:mb-12">
                            ...
                            <p className="mt-4 text-lg text-gray-300 max-w-2xl mx-auto">
                                GreyCare provides a comprehensive platform to help you manage your medical records securely in the cloud, streamlining clinical workflows and enhancing patient care.
                            </p>
                        </div>

                        <div className="grid gap-8 md:grid-cols-2">
                            {/* Card 1: Security/Health Focus */}
                            <div className="flex flex-col items-start gap-4 rounded-xl bg-white/90 backdrop-blur-sm p-6 shadow-xl transition duration-300 ease-in-out hover:shadow-2xl hover:-translate-y-1">
                                ...
                                <div>
                                    <h3 className="text-xl font-semibold text-gray-900">
                                        Hospital Data, Secured
                                    </h3>
                                    <p className="mt-3 text-gray-700 leading-relaxed">
                                        GreyCare offers a secure platform for managing your health data. With features like real-time updates, secure sharing, and easy access to medical records, we empower you to take control of hospital operations.
                                    </p>
                                </div>
                            </div>

                            {/* Card 2: Documentation/Support Focus */}
                            <div className="flex flex-col items-start gap-4 rounded-xl bg-white/90 backdrop-blur-sm p-6 shadow-xl transition duration-300 ease-in-out hover:shadow-2xl hover:-translate-y-1">
                                <div className={`flex size-14 shrink-0 items-center justify-center rounded-full ${primaryIconBgClass} shadow-md`}>
                                ...
                                <div>
                                    ...
                                    <p className="mt-3 text-gray-700 leading-relaxed">
                                        Whether you're a healthcare professional or an administrator, our resources are designed to guide you through every aspect of using our platform to manage medical records securely.
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <footer className="pt-16 pb-8 text-center text-sm text-gray-400">
                        © {new Date().getFullYear()} GreyCare Hospital Management System. All rights reserved.
                    </footer>
                </div>
            </div>
        </>
