...
export default function Edit({ auth, facilityoption, chartOfAccounts, billinggroups }) {
    return (
            ...
            <div className="py-12">
                <div className="mx-auto max-w-4xl sm:px-6 lg:px-8">
                    <div className="bg-white p-6 shadow sm:rounded-lg">
                        <FacilityOptionForm option={facilityoption} chartOfAccounts={chartOfAccounts} billinggroups={billinggroups} />
                    </div>
                </div>
            </div>
        </AuthenticatedLayout>
