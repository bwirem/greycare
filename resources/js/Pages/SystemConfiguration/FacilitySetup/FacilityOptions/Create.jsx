...
export default function Create({ auth, chartOfAccounts, billinggroups, deathstatuses }) {
    return (
            ...
            <div className="py-12">
                <div className="mx-auto max-w-4xl sm:px-6 lg:px-8">
                    <div className="bg-white p-6 shadow sm:rounded-lg">
                        <FacilityOptionForm chartOfAccounts={chartOfAccounts} billinggroups={billinggroups} deathstatuses={deathstatuses} />
                    </div>
                </div>
            </div>
        </AuthenticatedLayout>
