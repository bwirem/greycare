...
import {
    faRadiation,    // Modalities
    faXRay,         // Procedures
    faArrowRight
} from '@fortawesome/free-solid-svg-icons';

export default function RadSetupIndex({ auth }) {
    const dashboardItems = [
        { 
            title: "Modalities", 
            icon: faRadiation, 
            routeName: 'systemconfiguration7.modalities.index', 
            color: 'purple', 
            description: "Manage Machines (CT, MRI, X-Ray) & DICOM Settings." 
        },
        { 
            title: "Procedures", 
            icon: faXRay, 
            routeName: 'systemconfiguration7.procedures.index', 
            color: 'blue', 
            description: "Manage Orderable Exams and Pricing." 
        },
    ];

    return (
        <AuthenticatedLayout user={auth.user} header={<h2 className="text-xl font-semibold">Radiology Configuration</h2>}>
            <Head title="Radiology Setup" />
            <div className="py-12">
