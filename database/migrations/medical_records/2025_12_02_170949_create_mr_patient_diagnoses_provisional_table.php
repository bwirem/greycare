...
return new class extends Migration
{
    ...
    {
        Schema::create('mr_patient_diagnoses_provisional', function (Blueprint $table) {
            $table->id();
           ...
           // 1. The ID from dxt_diagnoses_xxx tables
            ...
            // 2. The Table Name (e.g., 'dxtdiagnosesipd', 'dxtdiagnosesdental')
    ...
    {
        Schema::dropIfExists('mr_patient_diagnoses_provisional');
    }
};